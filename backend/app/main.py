...
st.title("Image Classification API")
...
from backend.app.api.routes import health, predict, metadata, auth, admin
...
def create_app() -> FastAPI:
    ...
    if static_dir.exists() and static_dir.is_dir():
        ...
        async def serve_spa(full_path: str):
            ...
            if full_path.startswith("api/") or full_path.startswith("docs") or full_path.startswith("redoc") or full_path.startswith("auth/") or full_path.startswith("admin/"):
